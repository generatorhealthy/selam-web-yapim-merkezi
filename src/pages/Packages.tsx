            ...
            <div className="text-center bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 rounded-3xl p-16 text-white shadow-3xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <Button 
                  ...
                  className="bg-white text-gray-900 hover:bg-gray-100 border-0 shadow-2xl text-lg px-12 py-6 rounded-2xl font-bold transition-all duration-300 hover:scale-105"
                >
