...
const CampaignPremiumPackage = () => {
  const handleWhatsAppContact = () => {
    ...
    const message = "Merhaba, Kampanyalı Premium Paket ile ilgili bilgi almak istiyorum";
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-6 py-3 mb-6 shadow-lg">
                ...
                <span className="text-sm font-medium text-gray-700">Kampanyalı Paket</span>
              </div>
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="relative group transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl ring-2 ring-purple-400 shadow-xl bg-gradient-to-br from-white to-purple-50/50 backdrop-blur-sm border-0">
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                  <Badge className="bg-gradient-to-r from-purple-500 to-purple-600 text-white px-6 py-3 text-sm font-semibold shadow-lg">
                ...
                <CardHeader className="text-center pb-4 pt-8">
                  <div className="mb-4">
                    <div className="w-16 h-16 mx-auto rounded-2xl bg-gradient-to-r from-purple-500 to-purple-600 p-4 shadow-lg">
                      <Sparkles className="w-8 h-8 text-white" />
                    </div>
                  </div>
                  
                  <CardTitle className="text-2xl font-bold text-gray-900 mb-2">
                    {campaignPremiumPackage.name}
                  </CardTitle>
                  
                  <div className="space-y-2">
                    <div className="text-lg text-gray-500 line-through">
                      {campaignPremiumPackage.originalPrice.toLocaleString('tr-TR')} ₺
                    </div>
                    <div className="text-5xl font-bold text-gray-900 mb-2">
                      {campaignPremiumPackage.price.toLocaleString('tr-TR')} ₺
                    </div>
                    <div className="text-sm text-gray-600 mb-4">
                      /aylık KDV Dahil
                    </div>
                    <Badge variant="destructive" className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-4 py-1">
                      %{Math.round(((campaignPremiumPackage.originalPrice - campaignPremiumPackage.price) / campaignPremiumPackage.originalPrice) * 100)} İndirim
                    </Badge>
                  </div>
                </CardHeader>
                ...
                <CardContent className="px-6 pb-8">
                  <div className="space-y-4 mb-8">
                    {campaignPremiumPackage.features.map((feature, index) => (
                  ...
                  <Button 
                    asChild
                    className="w-full py-6 text-lg font-semibold shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] bg-gradient-to-r from-purple-500 to-purple-600 hover:opacity-90 text-white border-0"
                  >
                    <Link 
                      to="/odeme-sayfasi" 
                      state={{ 
                        packageData: {
                          id: "campaign-premium",
                          name: campaignPremiumPackage.name,
                          price: campaignPremiumPackage.price,
                          originalPrice: campaignPremiumPackage.originalPrice,
                          features: campaignPremiumPackage.features,
                          type: "campaign-premium"
                        }
                      }}
                    >
...
export default CampaignPremiumPackage;
