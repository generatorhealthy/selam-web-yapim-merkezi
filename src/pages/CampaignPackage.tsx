        ...
        <div className="relative z-10">
          <div className="container mx-auto px-4 py-12">
            ...
            <div className="max-w-4xl mx-auto">
              <Card className="relative group transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl ring-2 ring-blue-400 shadow-xl bg-gradient-to-br from-white to-blue-50/50 backdrop-blur-sm border-0">
                ...
                <CardHeader className="text-center pb-4 pt-8">
                  <div className="mb-4">
                    <div className={`w-16 h-16 mx-auto rounded-2xl bg-gradient-to-r from-blue-500 to-blue-600 p-4 shadow-lg`}>
                ...
                <CardContent className="px-6 pb-8">
                  ...
                  <Button 
                    asChild
                    className="w-full py-6 text-lg font-semibold shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] bg-gradient-to-r from-blue-500 to-blue-600 hover:opacity-90 text-white border-0"
                  >
                    <Link 
                      to="/odeme-sayfasi" 
                      state={{ 
