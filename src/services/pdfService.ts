  ...
  const doc = new Document({
    sections: [{
      ...
      children: [
            ...
            new TextRun({
              text: `Ad Soyad: ${customerData.name} ${customerData.surname}\n` +
                    ...
                    (customerType === 'company' && customerData.companyName ? 
                      `\nFirma Adı: ${customerData.companyName}\nVergi No: ${customerData.taxNo}\nVergi Dairesi: ${customerData.taxOffice}` : ''),
              size: 20
            }),
          ],
          spacing: { after: 300 }
        ...
        // Detaylı Hizmet Koşulları
        new Paragraph({
          children: [
            new TextRun({
              text: "📜 DETAYLI HİZMET KOŞULLARI VE BİLGİLERİ",
              bold: true,
              size: 24,
              color: "A855F7"
            }),
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "1. HİZMET TANIMI VE KAPSAMI:",
              bold: true,
              size: 20
            }),
          ],
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Bu sözleşme kapsamında sunulan hizmet, DoktorumOL dijital sağlık platformunda profesyonel doktor profili oluşturma, yönetme ve hasta ile etkileşim kurma imkanı sağlayan dijital bir hizmettir. Hizmet tamamen dijital ortamda sunulmakta olup, herhangi bir fiziksel teslimat içermemektedir.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "2. HİZMET SÜRESİ VE ÖDEME KOŞULLARI:",
              bold: true,
              size: 20
            }),
          ],
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Hizmet süresi 12 (on iki) ay olup, ödeme aylık taksitler halinde yapılacaktır. İlk ödeme hizmetin başlangıcında, sonraki ödemeler her ayın aynı gününde otomatik olarak tahsil edilecektir. Ödeme yapılmayan durumlarda hizmet askıya alınabilir.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "4. CAYMA HAKKININ KULLANILMASI:",
              bold: true,
              size: 20
            }),
          ],
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Cayma hakkının kullanılması halinde, alıcı tarafından ödenen tüm bedeller 10 (on) gün içerisinde iade edilir. Cayma bildirimi info@doktorumol.com.tr e-posta adresine veya kayıtlı adrese yazılı olarak yapılabilir.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "5. HİZMET BAŞLANGICI VE AKTİVASYON:",
              bold: true,
              size: 20
            }),
          ],
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Hizmet, ödeme onayının alınmasından sonra en geç 24 saat içerisinde aktifleştirilir. Kullanıcı hesap bilgileri ayrı bir e-posta ile gönderilir. Hizmetin kullanımı için internet bağlantısı gereklidir.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "6. SORUMLULUKLAR VE YÜKÜMLÜLÜKLER:",
              bold: true,
              size: 20
            }),
          ],
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Satıcı, platform üzerinden kesintisiz hizmet sunmaya, teknik destek sağlamaya ve kullanıcı verilerinin güvenliğini sağlamaya yükümlüdür. Alıcı, platform kurallarına uymaya, doğru bilgi vermeye ve aylık ödemelerini zamanında yapmaya yükümlüdür.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Hizmet, alıcı tarafından herhangi bir zamanda iptal edilebilir. İptal durumunda kalan aylık ödemeler tahsil edilmez. Ancak kullanılan dönem için ödeme iadesi yapılmaz. Satıcı, platform kurallarının ihlali durumunda hizmeti tek taraflı olarak sonlandırabilir.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "8. KİŞİSEL VERİLERİN KORUNMASI:",
              bold: true,
              size: 20
            }),
          ],
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Toplanan kişisel veriler, 6698 sayılı Kişisel Verilerin Korunması Kanunu kapsamında işlenir ve korunur. Detaylı bilgi için www.doktorumol.com.tr/gizlilik-politikasi adresini ziyaret edebilirsiniz.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Bu sözleşmeden doğan uyuşmazlıklar öncelikle dostane yollarla çözülmeye çalışılır. Çözüm sağlanamayan hallerde İstanbul Mahkemeleri ve İcra Müdürlükleri yetkilidir. Tüketici şikayetleri için Tüketici Hakem Heyetleri ve Tüketici Mahkemelerine başvuru yapılabilir.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Bu sözleşme elektronik ortamda akdedilmiş olup, onaylanan şekliyle geçerlidir. Sözleşme şartlarında değişiklik yalnızca yazılı anlaşma ile yapılabilir. Sözleşmenin herhangi bir hükmünün geçersiz olması diğer hükümlerin geçerliliğini etkilemez.",
              size: 20
            }),
          ],
          spacing: { after: 400 }
        ...
        // Onay ve Kabul Bölümü
        new Paragraph({
          children: [
            new TextRun({
              text: "✍️ ONAY VE KABUL",
              bold: true,
              size: 28,
              color: "22C55E"
            }),
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Bu ön bilgilendirme formunda yer alan tüm bilgileri okudum, anladım ve kabul ediyorum. Ürün/hizmet bedeli, ödeme şekli, teslimat koşulları ve diğer tüm şartlar hakkında tam bilgi sahibi olduğumu beyan ederim.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "6502 sayılı Tüketicinin Korunması Hakkında Kanun kapsamındaki cayma hakkım konusunda bilgilendirildiğimi, bu hakkımı 14 gün içerisinde kullanabileceğimi bildiğimi onaylıyorum.",
              size: 20
            }),
          ],
          spacing: { after: 200 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "Bu belge elektronik ortamda düzenlenmiş olup, 5070 sayılı Elektronik İmza Kanunu kapsamında geçerlidir.",
              size: 20
            }),
          ],
          spacing: { after: 300 }
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "MÜŞTERİ BİLGİLERİ VE DİJİTAL ONAYI:",
              bold: true,
              size: 20
            }),
          ],
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "DİJİTAL İMZA: Bu belge elektronik ortamda kabul edilmiş ve dijital olarak imzalanmıştır.",
              bold: true,
              size: 20,
              color: "22C55E"
            }),
        ...
        new Paragraph({
          children: [
            new TextRun({
              text: "* Bu belge müşteri tarafından dijital ortamda onaylanmış ve yasal geçerliliğe sahiptir.\n" +
