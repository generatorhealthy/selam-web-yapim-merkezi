...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      backup_1789056000_appointments: {
        Row: {
          appointment_date: string | null
          appointment_time: string | null
          appointment_type: string | null
      ...
      backup_1789056000_automatic_orders: {
        Row: {
          amount: number | null
          company_name: string | null
          company_tax_no: string | null
      ...
      backup_1789056000_client_referrals: {
        Row: {
          client_contact: string | null
          client_name: string | null
          client_surname: string | null
      ...
      backup_1789056000_test_questions: {
        Row: {
          created_at: string | null
          id: string | null
          is_required: boolean | null
      ...
      backup_1789056000_test_results: {
        Row: {
          answers: Json | null
          created_at: string | null
          id: string | null
      ...
      backup_1789056000_user_profiles: {
        Row: {
          created_at: string | null
          email: string | null
          id: string | null
