        ...
        "OrderProducts": [
          {
            ...
            "ProductQuantity": 1,
            "ProductUnitPriceTaxExcluding": Number(order.amount || 0) / 1.20,
            "ProductUnitPriceTaxIncluding": Number(order.amount || 0),
            "ProductTotalPriceTaxExcluding": Number(order.amount || 0) / 1.20,
            "ProductTotalPriceTaxIncluding": Number(order.amount || 0),
            "ProductVatRate": 20,
            "ProductVatAmount": Number(order.amount || 0) - (Number(order.amount || 0) / 1.20),
            "ProductCurrency": "TRY"
          }
        ],
        "OrderTotalTaxExcluding": Number(order.amount || 0) / 1.20,
        "OrderTotalTaxIncluding": Number(order.amount || 0),
        "OrderTotalVatAmount": Number(order.amount || 0) - (Number(order.amount || 0) / 1.20),
        "OrderCurrency": "TRY",
        "OrderNote": "",
        "CargoTrackingNumber": "",
        "InvoiceLink": ""
